        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <form id="form1" method="get" action="/" class="form-horizontal">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <select class="selectpicker" name=type id=type data-style="btn btn-rose btn-round" title="Single Select" data-size="7">
                                                <option disabled selected>Choose User Type</option>
                                                <option value="admin" selected>Admin</option>
                                                <option value="waiter" selected>Waiter</option>
                                                <option value="procurement" selected>Procurement Manager</option>
                                                <option value="manager" selected>Manager</option>
                                            </select>
                                        </div>


                                        <label class="col-sm-2 label-on-left">User Image: </label>
                                            <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail img-circle">
                                                    <img src="assets/img/placeholder.jpg" alt="...">
                                                </div>
                                                <div id=imageDiv class="fileinput-preview fileinput-exists thumbnail img-circle"></div>
                                                <div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 text-right">
                                            <button type=button class="btn btn-rose" name=submit id=submit>Add User
