...
if (isset($_GET['id']))
{
    $sql = "select * from `item_category` where id=".$_GET['id'];
...
<script>
    ...
    function edit(id){
        var path = (window.location.pathname.split('/').slice(0, -1).join('/') + "/edit-cuisine.php?id="+id);
        ...
        <nav class="navbar navbar-transparent navbar-absolute">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href=""> Cuisine </a>
                </div>
                    ...
                    <div class="card">
                        <form method="get" action="/" class="form-horizontal">
                            ...
                            <div class="card-content">
                                ...
                                <div class="row">
                                    <label class="col-sm-2 label-on-left">Cuisine Name: </label>
                                    <div class="col-sm-5">
                                        <div class="form-group label-floating is-empty">
                                            <label class="control-label"></label>
                                            <input type="text" class="form-control" name=cosineName id=cosineName value='<?php echo $name; ?>'>
                                            <span class="help-block">Enter name of Cuisine.</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <label class="col-sm-2 label-on-left">Cuisine Image: </label>
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-right">
                                        <button type=button class="btn btn-rose" name=submit id=submit>Update Cuisine<div class="ripple-container"></div></button>
                                    </div>
                                </div>
    ...
    $(document).ready(function() {
        ...
        $("#submit").click(function() {
            ...
            if(myimg){
                ...
                mysrc = getBase64Image(document.getElementById("myimg"));
            }
            ...
            $.ajax({
                ...
                success:function(data) {
                    ...
                    if(data == "1"){
                        ...
                        $.notify({
                            icon: "notifications",
                            message: "Error. Cuisine not Updated."
