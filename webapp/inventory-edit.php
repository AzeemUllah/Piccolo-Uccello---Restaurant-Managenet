...
<script>
    function fetch(){
        //alert("abc");
        $.ajax({
            url:"api/api-fetchInventory.php",
            type:"POST",
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> Edit Inventory </a>
                    </div>
                        ...
                        <div class="card">
                            <form method="get" action="/" class="form-horizontal">
                                ...
                                <div class="card-content">
									...
									<div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group label-floating is-empty">
                                                ...
                                                <span class="help-block">Enter unit. eg: kg, litre etc.</span>
                                            </div>
                                        </div>
									...
									<input type="text" style="display: none;" class="form-control" name=id id=id value='<?php echo $id; ?>'>

                                    <div class="row">
                                        <div class="col-md-12 text-right">
                                            <button type=button class="btn btn-rose" name=submit id=submit>Update Item<div class="ripple-container"></div></button>
                                        </div>
                                    </div>
...
function del(id){
			$.ajax({
        url:"api/api-deleteInventory.php",
        type:"POST",
        ...
        success:function(data) {
		  ...
		  if(data == "1"){
        	...
        	message: "Inventory Deleted."
			  ...
			  $.notify({
        	icon: "notifications",
        	message: "Error. Inventory not Deleted."
...
//alert("abc");
        ...
        $.ajax({
            url:"api/api-updateInventory.php",
            type:"POST",
            ...
            success:function(data) {
               console.log(data);
                if(data == "1"){
                    ...
                    $.notify({
                        icon: "notifications",
                        message: "Error. Inventory not Updated."
