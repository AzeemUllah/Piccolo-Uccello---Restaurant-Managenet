...
if (isset($_GET['id']))
{
    $sql = "select * from `item_type` where id=".$_GET['id'];
        ...
        <nav class="navbar navbar-transparent navbar-absolute">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Update Dish Type </a>
                </div>
                    ...
                    <div class="card">
                        <form method="get" action="/" class="form-horizontal">
                            <div class="card-header card-header-text" data-background-color="rose">
                                <h4 class="card-title">Update Dish Type</h4>
                            </div>
                            <div class="card-content">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-right">
                                        <button type=button class="btn btn-rose" name=submit id=submit>Update Dish Type<div class="ripple-container"></div></button>
                                    </div>
                                </div>
            ...
            $.ajax({
                ...
                success:function(data) {
                    ...
                    if(data == "1"){
                        ...
                        $.notify({
                            icon: "notifications",
                            message: "Error. Dish Type not Updated."
