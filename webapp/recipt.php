...
<head>
    <meta charset="UTF-8">
    <p>Piccolo Ucello | Payment Recipt</p>
</head>
<body>
<!DOCTYPE html>
<html lang="en">
...
<body>
<div style="float:left; width:400px; box-shadow:0 0 3px #aaa; height:auto;color:#666;">
    <div style="width:100%; padding:10px; float:left;  color:#fff; font-size:30px; text-align:center; border-bottom: 1px solid #cccccc;">
        ...
        <p style="font-size:40%;">
            <font face="verdana" color="black">25-C, Main Khayaban-e-Nishat, Phase 6, DHA
                745500 Karachi</font>
        </p>
        <p style="font-size:38%;">
            <font face="verdana" color="black">Phone# 0321 2021222 </font>
        </p>
    ...
    <div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12" style="height: 30px;border-bottom: 1px solid #dddddd;" >
            ...
            <div class="col-md-6 col-sm-6 col-xs-6">
                <p style="float: right;">Mr. Someone</p>
            </div>
        </div>
    </div>
    <table class="table">
...
<?php
        ...
        $sql2 = "select oi.id, oi.quantity, i.name, oi.total_price, oi.wastage_status from order_items oi, item i where oi.item_id = i.id and oi.order_id=".$_GET['id'];
...
?>
    ...
    <div style="padding-top: 157px">
        <p style="text-align:center">NTN: 1185112-7</p>
