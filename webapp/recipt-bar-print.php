...
<html lang="en">
<head>
    <title>Piccolo Ucello | Bar Recipt</title>
    <meta charset="utf-8">
...
<div style="padding-top: 25px; float:left; width:400px; box-shadow:0 0 3px #aaa; height:auto;color:#666;">
    <div style="width:100%; padding:10px; float:left;  color:#fff; font-size:30px; text-align:center; border-bottom: 1px solid #cccccc;">
        ...
        <p style="font-size:50%;">
            <font face="verdana" color="black">BAR ORDER</font>
        </p>
    </div>
    <div>
    ...
    <table class="table">
        ...
        $sql2 = "select oi.id, oi.quantity, i.name, oi.total_price, oi.notes, oi.wastage_status from order_items oi, item i where oi.item_id = i.id and oi.order_id=".$_GET['id'] ." AND i.location='Bar' and oi.printed='No'";
        ...
        if ($result2->num_rows > 0) {
            ...
            <td style="display: grid;  ">'.$row2["name"].'<br>         
