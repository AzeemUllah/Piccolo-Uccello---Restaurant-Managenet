...
if (isset($_GET['id']))
{
    $sql = "select * from `table_status` where table_id=".$_GET['id'];
                            ...
                            <div class="card-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-group label-floating is-empty">
                                            ...
                                            <input type="text" class="form-control" name=tableName id=tableName value='<?php echo $name;?>'>
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-right">
                                        <button type=button class="btn btn-rose" name=submit id=submit>Update Table<div class="ripple-container"></div></button>
                                    </div>
                                </div>
