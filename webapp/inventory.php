...
<script>
    ...
    function edit(id){
        var path = (window.location.pathname.split('/').slice(0, -1).join('/') + "/inventory-edit.php?id="+id);
                            ...
                            <form method="get" action="/" class="form-horizontal">
                                ...
                                <div class="card-content">
									...
									<div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group label-floating is-empty">
                                                ...
                                                <span class="help-block">Enter Price of each unit</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <label class="col-sm-2 label-on-left">Inventory Image: </label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 text-right">
                                            <button type=button class="btn btn-rose" name=submit id=submit>Add Item<div class="ripple-container"></div></button>
                                        </div>
                                    </div>
...
function del(id){
    ...
    $("#submit").click(function() {
        ...
        $.ajax({
            url:"api/api-insertInventory.php",
            type:"POST",
