                            ...
                            <div class="card">
                                <form method="get" action="/" class="form-horizontal">
									...
									<div class="row">
										...
										<button type=button class="btn btn-rose" name=submit id=submit>Add Cuisine<div class="ripple-container"></div></button>
										</div>
									</div>
        ...
        success:function(data) {
		  ...
		  if(data == "1"){
        	...
        	message: "Cuisine Inserted."
			  ...
			  $.notify({
        	icon: "notifications",
        	message: "Error. Cuisine not added."
